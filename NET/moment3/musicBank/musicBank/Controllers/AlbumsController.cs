...
namespace musicBank.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        public AlbumsController(MusicBankContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,Name,Artist,MumberOfSongs,Rented")] Albums albums)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Name,Artist,MumberOfSongs,Rented")] Albums albums)
        {
            if (id != albums.id)
            {
                return NotFound();
