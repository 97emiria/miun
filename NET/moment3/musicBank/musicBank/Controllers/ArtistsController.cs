...
namespace musicBank.Controllers
{
    public class ArtistsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            TempData["ArtistList"] = new List<string> {"Ett", "tva", "three"};
        ...
        public async Task<IActionResult> Create([Bind("id,Name,Country")] Artists artists)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Name,Country")] Artists artists)
        {
            if (id != artists.id)
            {
                return NotFound();
