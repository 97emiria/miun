...
namespace musicBank.Controllers
{
    public class BorrowerController : Controller
    {
        ...
        public BorrowerController(MusicBankContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BorrowerID,NameBorrower,Phone,RegisteredSince")] Borrower borrower)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BorrowerID,NameBorrower,Phone,RegisteredSince")] Borrower borrower)
        {
